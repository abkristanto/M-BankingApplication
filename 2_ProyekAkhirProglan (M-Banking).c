...
struct identitas{
	...
	int setoranAwal;
	char noTelepon[100];
	char noPAM[100], noPLN[100], noTelkom[100];
	char email[100];
	int tambahSaldo;
	int kurangSaldo;
	struct tanggal ttl;
...
void logo()
{
	...
	printf("                    .ohs.    `--`-::::::::::::--..``      ``    -oss.                        \n");
	printf("                   -yh+`     ::`-:::::::-..``       `--`.oss/ `/sss-                         \n");
	printf("                  /hh/      -::-:--.``      ```    -ssso`ssss:osso.                          \n");
	printf("                 /hh+       ..``           :ssso/-``ssss-:sssssssso/-`                       \n");
	printf("                :hho              -+o/.    -sssssssoossso`ssss:-/ossss:                      \n");
	printf("               .hhh.    `.::-    .sssss+.   ossssosssssss::ssso   `.-.      `-:/-            \n");
	printf("               ohh+  .+ssosyy/   +sssosss+. .ssss``-+ssss+ :::`      `.-/+ossssso            \n");
	printf("              .hhh.  :yy+ /ys-  .ssso/sssss+.+sss:    `.`      .-. -sssssssss/.              \n");
	printf("              +hhy   :yysosy+.  +sssso+:/sss-`--.       ``   `ssss+`:/-.:sssso               \n");
    printf("	      shhs   :yyo.:yys``ssso      `          `+sss:   ossss-     ossss-              \n");
	printf("              yhho   :yyo-+ys/  `--..`    `.-:/+oo+- `sssss`  -sssso     .sssss`             \n");
	printf("              yhhs   :yyss+:.    -osss.`/ossso++sssso :ssss+   +ssss:     +ssss:             \n");
	printf("              shhy   -/:..-:+:  :sssso``sssss.  :ssso  ossss-  .sssso     `+++:`             \n");
	printf("              +hhh-     /ssss: /ssss+`  :sssso/ossss-  -sssss/+ossso.                        \n");
	printf("              -hhho     +ssss//ssss/     ossssssssssso:`:ossssso+:.                          \n");
	printf("               shhh-    +sssssssss+      -sssso`-/ossso. ``````` ```..--                     \n");
	printf("               -hhhs`   +ssssssssss+-     +ssss-  `.--`   ``..--:::--::-  `:.                \n");
	printf("                +hhho`  +ssss//ssssss+`   `//:-     ``.--:::::::::- .:-  `ohys+-.            \n");
	printf("                `ohhho` +ssss: ./sssss:       ``.--::::::::::::::-`.:.  `shhhhhh/            \n");
	printf("                 `ohhhs.+ssss:   ./++:` ``.--:::::::::::::::::::..--`  -yhhhhhho`            \n");
	printf("                  `+hhh/+ssso.     ``.-:::::::::::::::::::::::-.--`  `+yhhhhhh/              \n");
	printf("                    /yh//o+-`      .::::::::::::::::::::::::---.`  `:yhhhhhhy:               \n");
	printf("                     .ossyhy+.`     `.-:::::::::::::::::::-.``   ./shhhhhhy+`                \n");
	printf("                       -shhhhhs/.`      ```...----....```     `-oyhhhhhhho-                  \n");
	printf("                        `-oyhhhhhso/-``                  ``-/oyhhhhhhhyo-                    \n");
	printf("                           .+yhhhhhhhyso+/:--.......-:/+osyhhhhhhhhys/.                      \n");
	printf("                             `-+syhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhys/.                         \n");
	printf("                                 .-/oyyhhhhhhhhhhhhhhhhhhhhyyo/-`                            \n");
	printf("                                      .-:/+oossyyyyssoo+/:-.                                 \n");
	printf("\n");
}
...
int menu()
{
    ...
    case '2':
        ...
        break;
    case '3':
        my_account();														//masuk ke fungsi my_account() jika ditekan 4
        break;
    case '4':
        transfer();															//masuk ke fungsi transfer() jika ditekan 5
        break;
    case '5':
        payment();															//masuk ke fungsi payment() jika ditekan 6
        break;
    case '6':
    	top_up();															//masuk ke fungsi top_up() jika ditekan 7
    	break;
    case '7':
    	history();															//masuk ke fungsi history() jika ditekan 8
    	break;
    case '8':
		help();																//masuk ke fungsi help() jika ditekan 9
		break;
	case '9':
		logout();
		system("cls");
...
void help()
{
    ...
    case '5':
        ...
        break;
    case '6':
    	help_top_up();														//masuk ke fungsi help_top_up() jika ditekan 6
    	break;
    case '7':
    	help_history();														//masuk ke fungsi help_history() jika ditekan 7
    	break;
	case '8':	
        help_exit();														//masuk ke fungsi help_exit() jika ditekan 8
        break;
    case '9':
    	help_logout();
    case '0':
    	menu();																//masuk ke fungsi menu() jika ditekan 9
    	break;
    default:																//jika user menginput selain opsi
    	printf("\n\n\t\t\t\t   Wrong input!\n");
    	printf("\t\t\t\t   Please input choice between 0 to 9 only!");
...
void create_new_account()
{
	...
	printf("Akun berhasil dibuat!!\nNikmati kemudahan dengan menggunakan m-Banking Bank Krut.\n");
	fclose(entry);
	system("pause");
	system("cls");
}
        ...
        {   
            ...
            switch(getch())
            {
                ...
                case '1':
	                ...
	                scanf("%s", update.noKTP);
	                fprintf(newrec,"Nama: %s  KTP: %s  TTL: %s , %d - %d - %d  Alamat: %s  E-mail: %s  No.Telp: %s  Saldo: Rp. %d \n", user.ndepan, update.noKTP, user.ttl.tempat, user.ttl.tanggal, user.ttl.bulan, user.ttl.tahun, user.alamat, user.email, user.noTelepon, user.setoranAwal);
	                system("cls");
            	...
            	case '2':
                	system("cls");
					printf("Masukan Tempat Lahir Anda : ");
	                scanf("%s", update.ttl.tempat);
	                fprintf(newrec,"Nama: %s  KTP: %s  TTL: %s , %d - %d - %d  Alamat: %s  E-mail: %s  No.Telp: %s  Saldo: Rp. %d \n", user.ndepan, user.noKTP, update.ttl.tempat, user.ttl.tanggal, user.ttl.bulan, user.ttl.tahun, user.alamat, user.email, user.noTelepon, user.setoranAwal);
	                system("cls");
	                printf("Changes saved!\n");
	                system("pause");
	                goto input;
            	...
            	case '3':
                	system("cls");
					printf("Masukan Tanggal Lahir Anda Anda : ");
	                scanf("%d/%d/%d", &update.ttl.tanggal, &update.ttl.bulan, &update.ttl.tahun);
	                fprintf(newrec,"Nama: %s  KTP: %s  TTL: %s , %d - %d - %d  Alamat: %s  E-mail: %s  No.Telp: %s  Saldo: Rp. %d \n", user.ndepan, user.noKTP, user.ttl.tempat, update.ttl.tanggal, update.ttl.bulan, update.ttl.tahun, user.alamat, user.email, user.noTelepon, user.setoranAwal);
	                system("cls");
					printf("Changes saved!\n");
	                system("pause");
	                goto input;
            	...
            	case '4':
	                ...
	                scanf("%s", update.alamat);
	                fprintf(newrec,"Nama: %s  KTP: %s  TTL: %s , %d - %d - %d  Alamat: %s  E-mail: %s  No.Telp: %s  Saldo: Rp. %d \n", user.ndepan, user.noKTP, user.ttl.tempat, user.ttl.tanggal, user.ttl.bulan, user.ttl.tahun, update.alamat, user.email, user.noTelepon, user.setoranAwal);
	                system("cls");
					printf("Changes saved!\n");
	                system("pause");
	                goto input;
...
{
	system("cls");
	int adm = 0, x=0, i=0, y=0, saldoBaru=0;;
	time_t currentTime;
	time(&currentTime);
	struct tm *myTime = localtime(&currentTime);
	FILE *cek, *cek1, *cek2, *cek3;
	...
	user.identity.pass, user.identity.tranpass)!= EOF){
		if(strcmp(user.identity.tranpass, password)==0&&strcmp(current.ndepan, user.ndepan)==0){
			...
			ketik("TRANSAKSI BERHASIL", 50);
			x = 1;
			fprintf(cek2,"Nama: %s  Kredit: %d  Keterangan: Transfer (Krut) ke (%s)  Tanggal: %d/%d/%d\n", user.ndepan, transact.nominal,
			transact.noRekening, myTime->tm_mday, myTime->tm_mon+1, myTime->tm_year+1900);
			fclose(cek1);
			break;
		}
...
int paymentPAM()
{
	...
	cek1 = fopen("contact.txt", "r");
	cek2 = fopen("dataTransaksiKredit.txt", "a+");
	printf("Masukan nomor ID PAM yang ingin dibayar: ");
	scanf("%s", transact.noPAM);
	printf("Mohon tunggu sejenak");
	for(i=0; i<=6; i++)
			{
				fordelay(100000000);
	...
	tanya:
	system("cls");
	printf("ID PAM yang ingin dibayar : %s\nBiaya yang perlu dibayar : %d\n", transact.noPAM, biaya);
	printf("\nApakah Informasi Tersebut Benar?\n    1. Ya (Lanjutkan Proses Transaksi)\n    2. Tidak (Kembali ke Pengisian Informasi)\n    0. Kembali ke Main Menu");
	switch(getch())
	{
		case '1':
	...
	user.identity.pass, user.identity.tranpass)!= EOF){
		if(strcmp(user.identity.tranpass, password)==0&&strcmp(current.ndepan, user.ndepan)==0){
			...
			ketik("TRANSAKSI BERHASIL", 50);
			x = 1;
			fprintf(cek2,"Nama: %s  Kredit: %d  Keterangan: Bayar (PAM) ke (%s)  Tanggal: %d/%d/%d\n", user.ndepan, biaya,
			transact.noPAM, myTime->tm_mday, myTime->tm_mon+1, myTime->tm_year+1900);
			fclose(cek1);
			break;
		}
	}
...
int paymentTelp()
{
	...
	user.identity.pass, user.identity.tranpass)!= EOF){
		if(strcmp(user.identity.tranpass, password)==0&&strcmp(current.ndepan, user.ndepan)==0){
			...
			transact.noTelkom, myTime->tm_mday, myTime->tm_mon+1, myTime->tm_year+1900);
			fclose(cek1);
			break;
		}
	}
...
{
	system("cls");
	printf("Pilihan eWallet: \n    1. Gopay\n    2. OVO\n    3. M-Tix\n    0. Exit to Main Menu\n\n");
	printf("Pilih eWallet yang ingin di top up: ");
	switch(getch())
	{
		case '1':
			system("cls");
		...
		case '0':
			...
			break;
		default:
			printf("Perintah tidak dikenali, mohon ulangi!\n");
			system("pause");
			system("cls");
			top_up();
	}
...
int topup_gopay()
{
	...
	time(&currentTime);
	struct tm *myTime = localtime(&currentTime);
	int x=0, i=0, y=0, saldoBaru=0;
	FILE *cek, *cek1, *cek2, *cek3;
	cek = fopen("IDPass.txt", "r");
	cek1 = fopen("contact.txt", "r");
	cek2 = fopen("dataTransaksiKredit.txt", "a+");
	printf("Masukan nomor HP yang akan di topup: ");
	scanf("%s", transact.noTelepon);
	printf("Masukan nominal angka yang ingin diisi: Rp. ");
	scanf("%d", &transact.nominal);
	printf("Masukan Kode Transaksi : ");
	...
	while(fscanf(cek1, "Nama: %s  KTP: %s  TTL: %s , %d - %d - %d  Alamat: %s  E-mail: %s  No.Telp: %s  Saldo: Rp. %d \n", uji.ndepan, uji.noKTP, uji.ttl.tempat
	,&uji.ttl.tanggal, &uji.ttl.bulan, &uji.ttl.tahun, uji.alamat, uji.email, uji.noTelepon, &uji.nominal )!=EOF){
		if(uji.nominal>=transact.nominal&&strcmp(uji.ndepan, current.ndepan)==0){
			y = 1;
			break;
		}
	}
	if(y==0){
		...
		saldoBaru = uji.nominal - transact.nominal;
	}
	
	tanya:
	system("cls");
	printf("nomor HP yang akan di topup : %s\nnominal angka yang ingin diisi : %d\n", transact.noTelepon, transact.nominal);
	printf("\nApakah Informasi Tersebut Benar?\n    1. Ya (Lanjutkan Proses Transaksi)\n    2. Tidak (Kembali ke Pengisian Informasi)\n    0. Kembali ke Main Menu");
	switch(getch())
	{
		case '1':
	...
	user.identity.pass, user.identity.tranpass)!= EOF){
		if(strcmp(user.identity.tranpass, password)==0&&strcmp(current.ndepan, user.ndepan)==0){
			...
			ketik("TRANSAKSI BERHASIL", 50);
			x = 1;
			fprintf(cek2,"Nama: %s  Kredit: %d  Keterangan: Isi (eWallet) ke (gopay)  Tanggal: %d/%d/%d\n", user.ndepan, transact.nominal,
...
int topup_ovo()
{
	...
	user.identity.pass, user.identity.tranpass)!= EOF){
		if(strcmp(user.identity.tranpass, password)==0&&strcmp(current.ndepan, user.ndepan)==0){
			...
			ketik("TRANSAKSI BERHASIL", 50);
			x = 1;
			fprintf(cek2,"Nama: %s  Kredit: %d  Keterangan: Isi (eWallet) ke (ovo)  Tanggal: %d/%d/%d\n", user.ndepan, transact.nominal,
			myTime->tm_mday, myTime->tm_mon+1, myTime->tm_year+1900);
			fclose(cek1);
			break;
		}
...
int topup_mtix()
{
	...
	while(fscanf(cek1, "Nama: %s  KTP: %s  TTL: bekasi , %d - %d - %d  Alamat: %s  E-mail: %s  No.Telp: %s  Saldo: Rp. %d \n", uji.ndepan, uji.noKTP, uji.ttl.tempat
	,&uji.ttl.tanggal, &uji.ttl.bulan, &uji.ttl.tahun, uji.alamat, uji.email, uji.noTelepon, &uji.nominal )!=EOF){
		printf("%d", uji.nominal);
		if(uji.nominal >= transact.nominal && strcmp(uji.ndepan, current.ndepan)==0){
			y = 1;
			break;
		}
	...
	user.identity.pass, user.identity.tranpass)!= EOF){
		if(strcmp(user.identity.tranpass, password)==0&&strcmp(current.ndepan, user.ndepan)==0){
			...
			ketik("TRANSAKSI BERHASIL", 50);
			x = 1;
			fprintf(cek2,"Nama: %s  Kredit: %d  Keterangan: Isi (eWallet) ke (mtix) Tanggal: %d/%d/%d\n", user.ndepan, transact.nominal, 
			myTime->tm_mday, myTime->tm_mon+1, myTime->tm_year+1900);
			fclose(cek1);
			break;
		}
...
void help_top_up()
{
	...
	printf("~~~~~HELP~~~~~\n");
	printf("Menu Top Up\n\n");
	printf("Pada menu ini, Anda dapat melakukan proses top up, seperti :");
	printf("    1. Gopay\n");
	printf("    2. OVO\n");
	printf("    3. M-Tix\n\n");
	system("pause");
